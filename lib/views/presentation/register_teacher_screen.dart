...
import 'package:tk_pertiwi/controllers/register_teacher_controller.dart';
...
class RegisterTeacherScreen extends StatelessWidget {
  RegisterTeacherScreen({super.key});
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          ...
                          const Text(
                            "Bergabunglah sebagai pendidik di TK Pintar\nIsi formulir berikut untuk mendaftar",
                            style: TextStyle(
                              fontSize: 14,
                  ...
                  Obx(() => BorderLabelInputField(
                        ...
                        errorText: controller.errorMessages['nip'],
                        isError: controller.errorMessages['nip']!.isNotEmpty,
                      )),
                  const SizedBox(height: 8),
                  Obx(() => BorderLabelInputField(
                        borderLabel: "Email",
